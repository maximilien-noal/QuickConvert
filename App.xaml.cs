...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        _logger.Information("Program {ProgramName} Start at {StartTime}", nameof(QuickConvert), DateTime.Now);

        Exit += (s, e) =>
        {
            _logger.Information("Program {ProgramName} End at {EndTime}", nameof(QuickConvert), DateTime.Now);
        };
    }
